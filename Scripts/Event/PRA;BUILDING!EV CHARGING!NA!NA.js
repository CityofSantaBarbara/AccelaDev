//PRA;BUILDING!EV CHARGING!NA!NA.js
//PRA:BUILDING/EV CHARGING/NA/NA
//Added by Gray Quarter
//Start - New On Demand EV Charging Station record for ACA
if (publicUser) {
  closeTask("Application Submittal", "Ready to Issue");
  closeTask("Permit Issuance", "Issued");

//END - New On Demand EV Charging Station record for ACA
